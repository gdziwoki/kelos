...
func printAgentConfigTable(w io.Writer, configs []kelosv1alpha2.AgentConfig, allNamespaces bool) {
	tw := tabwriter.NewWriter(w, 0, 0, 3, ' ', 0)
	if allNamespaces {
...
func printAgentConfigDetail(w io.Writer, ac *kelosv1alpha2.AgentConfig) {
